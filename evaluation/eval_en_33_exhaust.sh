...
python -u eval.py --gpath ../../contextual_linkpred_entgraph/entgraphs_dir/entgraphs_endata_contextual_bsz_32_nfill_100_2270000_2270000_"$prem_enc"_"$hypo_enc"_"$enc_dim"_"$sidenote" \
--dev --sim_suffix _sim.txt --method local_en_"$prem_enc"_"$hypo_enc"_"$enc_dim"_"$sidenote"_3_3_70000_dev --CCG 1 \
...
python -u eval.py --gpath ../../contextual_linkpred_entgraph/entgraphs_dir/entgraphs_endata_contextual_bsz_32_nfill_100_2270000_2270000_"$prem_enc"_"$hypo_enc"_"$enc_dim"_"$sidenote" \
--test --sim_suffix _sim.txt --method local_en_"$prem_enc"_"$hypo_enc"_"$enc_dim"_"$sidenote"_3_3_70000_test --CCG 1 \
--typed 1 --supervised 0 --oneFeat 1 --useSims 0 --featIdx 0 --write --exactType --backupAvg --no_lemma_baseline \
