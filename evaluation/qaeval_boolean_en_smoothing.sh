...
--all_preds_set_path ../../QAEval/nc_all_pred_set.json --threshold_samestr 1 --lm_graph_embs_dir "$smooth_embdir" \
--smoothing_k "$smoothing_k" --smooth_sim_order "$smooth_sim_order" ${flag1} ${flag2} ${flag3} ${flag4} ${flag5}